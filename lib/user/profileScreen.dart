...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  ImageProvider loadImage() {
    if (studentData.sImage!.isEmpty) {
      return const AssetImage("assets/i4.jpg",);
    }
    else {
      return NetworkImage(IMG_BASE_URL + studentData.sImage!);
    }
  }
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: kAppBarColor,
                        border:
                        Border.all(color: KDarkAppBarColor, width: 3),
                        image: DecorationImage(

                          fit: studentData.sImage!.isEmpty
                              ? BoxFit.cover
                              : BoxFit.contain,
                          image: loadImage(),
                        ),
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      ProfileDetailRaw(
                          title: "Gender : ", detail: studentData.gender!),
                      ProfileDetailRaw(
                          title: "DOB : ", detail: studentData.dob!),
                    ],
                  )
                ],
              ),
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: IconSplashButton(
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                  context, RegistrationScreen.id, arguments: {
                                "type": "edit",
  ...
  //     }
  //
  //     CommonResponse? response = await restApi.register(rollNumber! ,userName! ,dob!,gender!, contact!,email!,language!);
  //
  //     if(response!= null) {
  ...
  void logout() async {
    ...
    //Navigator.pushAndRemoveUntil(context, LoginScreen.id,ModalRoute.withName(LoginScreen.id));
  ...
  void updatestudentphoto(String imagePath) async {
    try{
      ...
      String id = await config.getStringSharedPreferences("userID");
      CommonResponse? response = await restApi.updateStudentPhoto(id, imagePath);
