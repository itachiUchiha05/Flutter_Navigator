...
class _LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    animation = Tween(begin: -1.0,end: 0.0).animate(
      CurvedAnimation(parent: animationController!, curve: const Interval(0.5,1.0,curve: Curves.bounceIn),),
    );
            ...
            children: <Widget>[
              ...
              InkWell(
                ...
                child: Row(
                  ...
                  children: const [
                    Padding(padding: EdgeInsets.only(left: 20.0,right: 20,top: 8,bottom: 8.0),
    ...
    try{
      ...
      if(response!= null) {
        if(response.result == "success") {
          ...
          config.setStringSharedPreferences("userName", response.data!.username);
